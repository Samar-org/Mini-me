...
input_dir = Path(r"C:\0001-Samar-MiniMe\01-Inventory-Management\unprocessed images")
output_dir = Path(r"C:\0001-Samar-MiniMe\01-Inventory-Management\processed images")
